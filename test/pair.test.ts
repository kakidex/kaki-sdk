...
describe('Pair', () => {
  ...
  const MATIC_MAINNET_WMATIC = new Token(ChainId.MATIC_MAINNET, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'WMATIC', 'Wrapped MATIC')
  const MATIC_MAINNET_USDC = new Token(ChainId.MATIC_MAINNET, '0x2791bca1f2de4661ed88a30c99a7a9449aa84174', 18, 'USDC', 'USDC')
  ...
  describe('#getAddress', () => {
    ...
    it('returns the correct address for MATIC Mainnet', () => {
      expect(Pair.getAddress(MATIC_MAINNET_WMATIC, MATIC_MAINNET_USDC)).toEqual('0x4Af68AD33Eb03960CE146D4EcFBA8f583D4A7AD8')
    })
  })
